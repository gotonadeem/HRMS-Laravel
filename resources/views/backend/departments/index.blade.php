	...
	<div class="col-md-12">
		<div class="panel">
			<header class="panel-heading">
				<h4 class="panel-title">{{ _lang('Departments List') }}</h4>
				<a class="btn btn-primary btn-xs pull-right ajax-modal" data-title="{{ _lang('Add New') }}" href="{{ route('departments.create') }}">
					{{ _lang('Add New') }}
				</a>
			</header>
					...
					<tbody>
						...
						<tr id="row_{{ $data->id }}">
        					...
        					<td class="designation">
        						<ul>
        						@foreach (get_table('designations', ['department_id' => $data->id], 'ASC') as $designation)
