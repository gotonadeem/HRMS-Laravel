...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(! $request->ajax()){
            return redirect('administration/languages')->with('success',_lang('Language Created Sucessfully'));
        }else{
            return response()->json(['result' => 'success', 'redirect' => url('administration/languages'), 'message' => _lang('Language Created Sucessfully')]);
        }
    ...
    {	
		...
		if(fwrite($file, $contents)){
            return redirect('administration/languages')->with('success',_lang('Updated Sucessfully'));
		}else{
            return redirect('administration/languages')->with('success',_lang('Update failed !'));
		}	
    }
